...
Das Styled Tile Collection Control dient dazu, Datensätze aus einer Datenquelle visuell als Kacheln aufzubereiten. Hierzu verbindest du das Control mit einer Datenquelle und erstellst anschließend ein individuelles Template, das mit den bereitgestellten Daten automatisch erweitert wird. Im Gegensatz zum [Styled Tile Control](/controls/14-de-tilecontrol.html) wird nicht nur eine einzelne Zeile, sondern eine Auswahl an Datensätzen visualisiert. Das Collection Control eignet sich besonders für Dashboards, auf denen Informationen wie bestimmte Statuswerte, Namen oder Kennzahlen aus einer Excelliste in einem individuell gestalteten Layout dargestellt werden sollen.
