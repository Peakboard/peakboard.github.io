...
1. Opacity (Appearance): Adjust the transparency of the image (0 to 100%) (1).
2. Stretch (Appearance) (2):
	2.1 Inactive: The image maintains its aspect ratio and is fitted into the frame.
	2.2 Active: The image is stretched to fill the area exactly.
