...
You can also let Peakbot adjust a project that is already open. For this there is the AI icon [Edit with AI] (1) in the editor's top toolbar – right next to [Preview] and [Upload].

![The "Edit with AI" icon in the editor toolbar](/assets/images/get_started/create-with-ai-03-edit-with-ai.png)
...
> **Note:** The AI features require an internet connection and a valid Peakboard account. Always review the result generated by the AI and adjust it manually if needed – Peakbot delivers a fast first draft, the final fine-tuning is done in the Peakboard Designer.
