...
With the button [General] (3) you can for example perform a software update and with the button [Project] (4) you can make basic settings for your visualization. You can also manage your Peakboard Boxes, Peakboard Edge and Peakboard Hub via the corresponding buttons (5). In addition, you will find access to the script editor (6), the fonts (7) and the project colors (8) in the menu bar. In the middle of the menu bar you will find the [quick access bar](/get_started/en-quick-access-hotkeys.html) (9). Clicking on the Peakbot symbol (10) opens the [built-in AI assistant Peakbot](/get_started/en-create-with-ai.html): it lets you create and edit complete projects from a simple text description and can also answer any open questions you may have.
