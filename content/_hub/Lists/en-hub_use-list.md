...
To do this, you create an appropriate script with the [script editor](/scripting/en-script-editor.html). In the script tree in block mode under [FUNCTIONS/Publish to external systems/Peakboard Hub] (1) you will find ready-made Building Blocks for this task, which you can adapt to your needs. In Script-Mode you can find the snippets under [DATA/List Name].

![Script editor](/assets/images/hub/use-list/use-list-01-buildingblocks.png)
